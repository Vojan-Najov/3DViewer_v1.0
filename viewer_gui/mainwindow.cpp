    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->plusButtonScale, &QPushButton::clicked, this, &MainWindow::positiveScale);
    connect(ui->minusButtonScale, &QPushButton::clicked, this, &MainWindow::negativeScale);
    connect(ui->plusButtonXTranslate, &QPushButton::clicked, this, &MainWindow::positiveTranslateForX);
    connect(ui->minusButtonXTranslate, &QPushButton::clicked, this, &MainWindow::negativeTranslateForX);
    connect(ui->plusButtonYTranslate, &QPushButton::clicked, this, &MainWindow::positiveTranslateForY);
    connect(ui->minusButtonYTranslate, &QPushButton::clicked, this, &MainWindow::negativeTranslateForY);
    connect(ui->plusButtonZTranslate, &QPushButton::clicked, this, &MainWindow::positiveTranslateForZ);
    connect(ui->minusButtonZTranslate, &QPushButton::clicked, this, &MainWindow::negativeTranslateForZ);
    connect(ui->plusButtonXRotate, &QPushButton::clicked, this, &MainWindow::positiveRotateForX);
    connect(ui->minusButtonXRotate, &QPushButton::clicked, this, &MainWindow::negativeRotateForX);
    connect(ui->plusButtonYRotate, &QPushButton::clicked, this, &MainWindow::positiveRotateForY);
    connect(ui->minusButtonYRotate, &QPushButton::clicked, this, &MainWindow::negativeRotateForY);
    connect(ui->plusButtonZRotate, &QPushButton::clicked, this, &MainWindow::positiveRotateForZ);
    connect(ui->minusButtonZRotate, &QPushButton::clicked, this, &MainWindow::negativeRotateForZ);
    connect(ui->colorBackgroundButton, &QPushButton::clicked, this, &MainWindow::chooseColorBackground);
    connect(ui->colorFaceButton, &QPushButton::clicked, this, &MainWindow::chooseColorLine);
    connect(ui->colorVertexButton, &QPushButton::clicked, this, &MainWindow::chooseColorVertex);
...
{
    QString file_name = QFileDialog :: getOpenFileName (NULL, "Title", "../..", "*.obj");
    if (file_name != "") {
...
{
    if (status) {
        QString file_name = QFileDialog :: getSaveFileName (NULL, "Title", ".", "*.obj");
        if (file_name != "") {
...
{
    if (vw_scene_get_model()) {
        ui->XvalueForTranslate->setValue(ui->XvalueForTranslate->value() + vw_scene_get_model()->dim/DIMENSION);
    }
}
...
{
    if (vw_scene_get_model()) {
        ui->YvalueForTranslate->setValue(ui->YvalueForTranslate->value() + vw_scene_get_model()->dim/DIMENSION);
    }
}
...
{
    if (vw_scene_get_model()) {
        ui->ZvalueForTranslate->setValue(ui->ZvalueForTranslate->value() + vw_scene_get_model()->dim/DIMENSION);
    }
}
...
{
    if (vw_scene_get_model()) {
        ui->XvalueForRotate->setValue(ui->XvalueForRotate->value() - vw_scene_get_model()->dim/DIMENSION);
    }
}
...
{
    if (vw_scene_get_model()) {
        ui->YvalueForRotate->setValue(ui->YvalueForRotate->value() - vw_scene_get_model()->dim/DIMENSION);
    }
}
...
{
    if (vw_scene_get_model()) {
        ui->ZvalueForRotate->setValue(ui->ZvalueForRotate->value() - vw_scene_get_model()->dim/DIMENSION);
    }
}
...
void MainWindow::chooseColorBackground()
{
    QColor color = QColorDialog::getColor(Qt::white, this, "Choose color");
    if (color.isValid()) {
        vw_scene_set_background_color(color.redF(), color.greenF(), color.blueF(), 1);
        ui->widget->pupdate();
    }
}
